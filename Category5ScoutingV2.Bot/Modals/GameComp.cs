    ...
    public static DiscordInteractionResponseBuilder CreateModal()
    {
        return new DiscordInteractionResponseBuilder()
            ...
            .AddComponents(new TextInputComponent(
                ...
                value: "This should be used to answer questions with as much detail possible. Use the Check Label to help remember things said by the other team. Give information that relates to the action of the game.",
                required: true,
